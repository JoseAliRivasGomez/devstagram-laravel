        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            ...
            <form action="{{route('posts.store')}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="titulo" name="titulo" placeholder="El titulo de la publicacion" class="border p-3 w-full rounded-lg
                ...
                <div class="mb-5">
                    ...
                    <textarea type="text" id="descripcion" name="descripcion" placeholder="La descripcion de la publicacion" class="border p-3 w-full rounded-lg
